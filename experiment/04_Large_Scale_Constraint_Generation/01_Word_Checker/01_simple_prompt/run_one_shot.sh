...
# Configuration
TEMPERATURE=0.2
TEMPLATE="Check if the following sentence contains one of the following set of words. Just answer True or False. Ensure to enclude your final answer into <answer></answer>. For instance, if the sentence contains one of the words, answer <answer>True</answer>; <answer>False</answer> otherwise."
# Create base output directory
mkdir -p "$BASE_OUTPUT_PATH"
