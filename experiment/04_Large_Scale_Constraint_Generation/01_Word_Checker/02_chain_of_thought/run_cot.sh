...
BASE_OUTPUT_PATH="$REPO_ROOT/experiment_results/WordChecker/CoT"
# Create base output directory
mkdir -p "$BASE_OUTPUT_PATH"

# Configuration
TEMPERATURE=0.4
TEMPLATE="Check if the following sentence contains one of the following set of words. Answer True or False. Please, make sure to think step by step. Ensure to enclude your final answer into <answer></answer>. For instance, if the sentence contains one of the words, answer <answer>True</answer>; <answer>False</answer> otherwise."
...
python ../02_chain_of_thought/chain_of_thought_inference.py \
